...
def setting():
    ...
    # './weights/attn_loss/epoch=81-step=59696-v1.ckpt'
    # './weights/attn_loss/epoch=82-step=60424-v1.ckpt'
    # './weights/attn_loss/epoch=83-step=61152-v1.ckpt'
    # epoch=84-step=61880-v1
    ckpt_pth = './weights/attn_loss/epoch=82-step=60424.ckpt'
